...
class Line2DRenderer {
    ...
    static A_POSISTION: number;
    static U_PROJECTION: WebGLUniformLocation;
    static U_COLOR: WebGLUniformLocation;

    static BUFFER: WebGLBuffer;
    
    static drawArrays( gl:WebGL2RenderingContext, data: Float32Array, mat_projection:number[], clr:Vector4 ) {
    ...
    static getProgram( gl:WebGL2RenderingContext ): WebGLProgram {
